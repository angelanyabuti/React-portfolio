...
import hero from '../assets/images-Perfumes-master/hero.png'
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center gap-10'>
            <div className='text-center lg:text-left max-w-xl'>
                ...
                <p className='text-gray-700 text-base sm:text-lg mb-6'>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eius minima a, laudantium dolorem fugiat facilis quaerat consequatur voluptate pariatur eaque, obcaecati ratione, hic nisi commodi illo eligendi soluta amet neque.
                </p>
