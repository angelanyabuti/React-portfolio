...
import { FaFacebookF, FaInstagram, FaMapMarkedAlt, FaPhone, FaTwitter } from 'react-icons/fa';
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
                <div className='bg-white p-8 rounded-lg shadow-xl border border-gray-100'>
                    ...
                    <form className='space-y-6' action="">
                        <div>
                            <label htmlFor="" className='block text-sm font-medium text-gray-800 mb-1'>Your Name</label>
                            <input type="text" 
                        ...
                        <div>
                            <label htmlFor="" className='block text-sm font-medium text-gray-800 mb-1'>Your Email</label>
                            <input type="email" 
                            className='w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent'
                        ...
                        <div>
                            <label htmlFor="" className='block text-sm font-medium text-gray-800 mb-1'>Your Message</label>
                            <textarea 
                            rows="5"
                            className='w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent'
                        ...
                        <div className='space-y-6'>
                            <div className='flex items-start'>
                                ...
                                <div>
                                    ...
                                    <p className='text-gray-800'>+1 (234) 567-888</p>
                                    <p className='text-gray-600 text-sm'>Mon-Fri: 9am-6pm</p>
                                </div>
                            </div>
                            <div className='flex items-start'>
                                <div className='bg-pink-200 p-3 rounded-full p-3 mr-4'>
