                ...
                <div className='flex flex-col lg:flex-row gap-12 mb-20'>
                    ...
                    <div className='lg:w-1/2 flex flex-col justify-center'>
                        ...
                        <p className='text-lg text-gray-600 mb-4'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, nemo. Ratione maiores repellat alias! 
                            Fugiat quisquam expedita necessitatibus distinctio aperiam nostrum explicabo! 
                            Excepturi similique iusto reiciendis sit sunt minima reprehenderit.
                        </p>
